...
fdescribe('MainPageComponent', () => {
    ...
    test('throws an error when the "Throw Error" button is clicked', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(new Error('This is a test error')); 
      },1000)
    ...
    setTimeout(()=> {fireEvent.click(screen.getByText('Toggle Dark Theme'));
        expect(toggleThemeMock).toHaveBeenCalled();}, 1000)
